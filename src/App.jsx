...
Formats:
- surfaces_detail: [{"categorie":"Bureaux","niveau":"5eme etage","surface_m2":"2224.98","prix_unitaire":"290","loyer_annuel":"645244"}] — categorie=Bureaux/Archives/Stationnement/Commerce/RIE/Autres. REGLE STRICTE: categorie ne peut jamais etre null. Si non explicite dans le document, infere-la depuis le contexte: etage/plateau/open-space → Bureaux; cave/local technique/archives → Archives; parking/sous-sol/emplacement/place/lot numerote en sous-sol → Stationnement; exterieur/lot numerote en surface/voirie → Stationnement. En cas de doute → Bureaux.
- break_options: ["31/08/2027","31/08/2030"]
- franchise_periodes: OBLIGATION de structurer TOUTES les franchises en tableau, y compris les franchises conditionnelles. Ne jamais laisser franchise_periodes vide si des franchises sont mentionnees dans le document. Format: [{"date_debut":"jj/mm/aaaa","date_fin":"jj/mm/aaaa","duree":"3 mois","montant":"123405","surface_assiette":"ex: LC1 (701,26 m²) ou Locaux Initiaux (2224,98 m²)","indexation_incluse":"Oui/Non/Non precise","condition":null}] — montant=chiffres bruts sans symbole (calcule-le si non explicite: loyer_annuel_assiette * duree_mois / 12). surface_assiette=denomination des locaux concernes avec m² si connu. Pour indexation_incluse: "Non" si franchise calculee sur le "loyer de base"; "Oui" uniquement si le texte dit explicitement "loyer indexe" ou "loyer en cours"; "Non precise" sinon. condition=texte de la condition si franchise conditionnelle (ex: "si non-delivrance de conge au 31/08/2030"), null si inconditionnelle. date_debut/date_fin=null si non precisees mais duree connue.
...
- loyer_signature_montant: OBLIGATION de renseigner ce champ si le bail mentionne un loyer, meme approximativement. MONTANT ANNUEL TOTAL HT/HC en euros, chiffres bruts sans symbole (ex: 493621.10). JAMAIS un prix unitaire au m². C'est le loyer global tel qu'il ressort du tableau de synthese ou du recapitulatif financier. Si tableau par lot/etage: additionner les loyers annuels de chaque ligne (somme des loyer_annuel de surfaces_detail). VERIFICATION OBLIGATOIRE: si surfaces_detail est rempli avec des loyer_annuel, loyer_signature_montant NE PEUT PAS etre null — calculer la somme.
- loyer_cours: MONTANT ANNUEL TOTAL HT/HC du loyer "de base" ou "en cours" au sens de l'article sur l'indexation, chiffres bruts. Souvent identique a loyer_signature_montant sauf si le bail mentionne explicitement un loyer en cours different (ex: apres indexation). Ne JAMAIS mettre un prix unitaire au m² ni un loyer mensuel.
- participations_travaux: tableau UNIQUEMENT si plusieurs enveloppes travaux distinctes (ex: locaux initiaux + locaux complementaires). Format: [{"libelle":"Locaux Initiaux","montant":"822701","date_limite":"31/12/2024","remarque":null}]. REGLE libelle: OBLIGATOIRE, jamais null. Reprendre la denomination exacte du document (ex: "Locaux Initiaux LC1", "Locaux Complementaires n°2 - 4eme etage", "LC n°1 lot 4"). Si plusieurs lots dans une meme enveloppe, les lister tous dans libelle (ex: "LC n°2 : 4eme etage + 33 places SS + 10 places ext."). Si une seule enveloppe, utiliser travaux_montant/travaux_date_factures comme d'habitude et laisser participations_travaux=[].`

const AVENANT_PROMPT = `Expert baux commerciaux français. Ce document est un AVENANT. JSON minifie sur UNE SEULE LIGNE, sans markdown.\n\nREGLES: Ne renseigne dans champs_modifies QUE les champs modifies. null pour les autres. Champs _montant=chiffres bruts sans symbole.\n\nCHAMP surface_change_type: qualifie la nature de la modification de surface. Valeurs: "inchangee" (aucune surface modifiee, seules les conditions changent), "ajout" (surfaces ajoutees en plus des existantes), "retrait" (surfaces retirees), "substitution" (remplacement de lots, surface totale stable), "mixte" (ajouts et retraits).\n\nCHAMP surfaces_delta: UNIQUEMENT si surface_change_type != "inchangee". Surfaces UNIQUEMENT concernees par la modification (nouvelles prises, lots restitues ou echanges). Meme format que surfaces_detail (categorie JAMAIS null, infere si besoin: etage→Bureaux, sous-sol/lot/emplacement→Stationnement, exterieur→Stationnement). Ajouter champ "sens":"ajout" ou "sens":"retrait" sur chaque ligne.\n\nCHAMP surfaces_avant: UNIQUEMENT si surface_change_type != "inchangee". Tableau complet des surfaces telles qu'elles existaient AVANT cet avenant (tel que decrit dans le bail d'origine ou les avenants precedents mentionnes dans ce document). Meme format que surfaces_detail (categorie JAMAIS null), sans champ "sens".\n\nCHAMP surfaces_apres: UNIQUEMENT si surface_change_type != "inchangee". Tableau complet des surfaces telles qu'elles existent APRES cet avenant (assiette locative consolidee). Meme format que surfaces_detail (categorie JAMAIS null), sans champ "sens".\n\n{"bail_reference":{"preneur":null,"bailleur":null,"date_bail_origine":null,"adresse":null,"immeuble":null},"date_effet_avenant":null,"date_signature_avenant":null,"objet_avenant":null,"surface_change_type":"inchangee","surfaces_delta":null,"surfaces_avant":null,"surfaces_apres":null,"champs_modifies":{"adresse":null,"immeuble":null,"ville":null,"type_bail":null,"duree_totale":null,"duree_ferme":null,"preneur":null,"bailleur":null,"garant":null,"date_effet":null,"date_signature":null,"break_options":null,"notice":null,"date_conge":null,"date_fin":null,"date_limite_travaux":null,"conditions_break":null,"surface_totale_m2":null,"surfaces_detail":null,"parking_nb_places":null,"parking":null,"rie":null,"loyer_signature_montant":null,"loyer_signature":null,"loyer_cours":null,"indexation":null,"franchise_periodes":null,"franchise":null,"charges":null,"depot_garantie_montant":null,"depot_garantie":null,"travaux_montant":null,"travaux_date_factures":null,"travaux_modalites":null,"participations_travaux":[],"indemnites":null,"indemnites_detail":null,"article_606":null,"conformite":null,"accession":null,"remise_en_etat":null,"maintenance":null,"destination":null,"sous_location":null,"cession":null}}`
