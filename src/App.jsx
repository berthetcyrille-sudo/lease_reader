...
REGLES: Guillemets droits ASCII uniquement. Pas de retour a la ligne dans les valeurs. Echappe les guillemets internes avec backslash. Champs _montant=chiffres bruts sans symbole ni espace (ex: 123405.50). null si absent.
...
- franchise_periodes: [{"date_debut":"jj/mm/aaaa","date_fin":"jj/mm/aaaa","duree":"3 mois","montant":"123405","indexation_incluse":"Oui/Non/Non precise","condition":null}] — montant=chiffres bruts sans symbole. Pour indexation_incluse: "Non" si le texte precise "loyer de base" ou "loyer fixe" sans mention d'indexation; "Oui" uniquement si le texte dit explicitement que la franchise s'applique au loyer indexe; "Non precise" si le texte ne le mentionne pas
