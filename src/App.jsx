...
REGLES: Guillemets droits ASCII uniquement. Pas de retour a la ligne dans les valeurs. Echappe les guillemets internes avec backslash. Champs _montant=chiffres bruts sans symbole ni espace (ex: 123405.50). null si absent. DISTINCTION IMPORTANTE: duree_totale=duree totale du bail. duree_ferme=periode pendant laquelle le preneur NE PEUT PAS resilier = periode jusqu'a la premiere break option ou premiere echeance de resiliation. Ex: bail 9 ans avec break au 31/08/2028 -> duree_ferme="3 ans" pas "9 ans".
